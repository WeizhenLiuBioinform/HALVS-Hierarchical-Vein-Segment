...
## Journal Extended Version

[![Journal](https://img.shields.io/badge/Journal-Extended_Version-blue)]([Revealing hierarchical structure of leaf venations via diffusion-refined label-efficient segmentation: Dataset and method - ScienceDirect](https://www.sciencedirect.com/science/article/pii/S2643651526000014))

[Weizhen Liu<sup>a,</sup>*](https://www.researchgate.net/profile/Weizhen-Liu), [Guangyu Lan<sup>a</sup>](https://arxiv.org/search/cs?searchtype=author&query=Lan,+G),  [Zhiwen Xing<sup>a</sup>](https://arxiv.org/search/cs?searchtype=author&query=Xing,+Z), [Jiayu Tan<sup>a</sup>](https://arxiv.org/search/cs?searchtype=author&query=Tan,+J),  [Jiale Liu<sup>a</sup>](https://arxiv.org/search/cs?searchtype=author&query=Liu,+J), [Qingzhong Liu<sup>c</sup>](https://arxiv.org/search/cs?searchtype=author&query=Liu,+Q),  [Dongzi Zhu<sup>c</sup>](https://www.researchgate.net/profile/Dong-Zi-Zhu),  [Xiaohui Yuan<sup>d,e,</sup>**](https://arxiv.org/search/cs?searchtype=author&query=Yuan,+X),  [Nanqing Dong<sup>b,f,</sup>***](https://eveningdong.github.io/)

<p align="center"><sup>a</sup>School of Computer Science and Artificial Intelligence, Wuhan University of Technology, Wuhan, Hubei, 430070, China</p>
<p align="center"><sup>b</sup>Shanghai Innovation Institute, Shanghai, 200231, China</p>
<p align="center"><sup>c</sup>Shandong Key Laboratory of Fruit Biotechnology Breeding, Shandong Institute of Pomology, Tai'an, Shandong, 271000, China</p>
<p align="center"><sup>d</sup>Yazhouwan National Laboratory, Sanya, Hainan, 572025, China</p>
<p align="center"><sup>e</sup>Jilin Provincial Key Laboratory of MycoPhenomics, Changchun, 130118, China</p>
<p align="center"><sup>f</sup>Shanghai Artificial Intelligence Laboratory, Shanghai, 200232, China</p>
<p align="center"><sup>*</sup> Corresponding author: Weizhen Liu</p>
<p align="center"><sup>**</sup> Corresponding author: Xiaohui Yuan</p>
<p align="center"><sup>***</sup> Corresponding author: Nanqing Dong</p>

![Journal Overview](assets/main_figure_1.png)

## Key Extensions and New Contributions

In this new version, we introduce a novel DDLR module that refines high-confidence pseudo-labels generated by the PSSS module via class-weighted diffusion conditioned on primary (1°) and secondary (2°) vein structural priors; add the clDice metric to better evaluate the integrity and connectivity of vein segmentation; conduct extended experimental validations, including new ablation studies and analyses for the PSSS module as well as comprehensive evaluations for the DDLR module (covering loss function ablation, weighting strategy, scalability, and backbone robustness); and perform comprehensive rewriting and refinement of the entire manuscript with expanded descriptions and in-depth explanations of technical details across all sections.
...
year = {2026},
issn = {2643-6515},
doi = {https://doi.org/10.1016/j.plaphe.2026.100164},
url = {https://www.sciencedirect.com/science/article/pii/S2643651526000014}
}
