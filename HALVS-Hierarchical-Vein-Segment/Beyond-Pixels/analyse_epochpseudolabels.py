...
from supervised import get_pseudolabels
...
#############################save best epoch
MODEL_NAME = '11_latest.pth'
PATH_SAVE='./output_pseudolabels_'+MODEL_NAME.split('.')[0]
...
#                                pin_memory=True, num_workers=1, drop_last=True, sampler=trainsampler_l)
    ...
    print(eval_mode)
    get_pseudolabels(model, valloader, eval_mode, cfg, PATH_SAVE)
